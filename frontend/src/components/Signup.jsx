        ...
        <>
          <div className="mb-6 flex justify-center">
            <img
              ...
              className="w-96 h-96 object-contain mb-4 rounded-t-lg"
            />
          </div>
          <p className="mb-6">
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center text-center p-10 bg-gradient-to-r from-[#ff5f6d] to-[#ffc371] text-white">
          <div className="max-w-md flex flex-col items-center">
            ...
            <div className="mb-16">
              <h1 className="text-9xl font-bold mb-4 font-jomhuria tracking-tight text-shadow">TabMark</h1>
              <p className="text-4xl font-lobster">Bookmarks, But Smarter</p>
            </div>

            {/* Rotating slide content */}
            <div className="min-h-[520px] flex items-center relative overflow-hidden">
              <div
          ...
          <div className="w-full max-w-lg">
            <div className="flex flex-col items-center mb-10">
              ...
              <img
                ...
                alt="TabMark Logo"
                className="w-20 h-20 text-[#ff9a8b] mb-10"
              />
